...
function PortletAppLoader(elementId)
{
  ...
  var requestCaller = new XMLHttpRequestCaller(applicationRoot+"/ajax?ajax_service=portletRegistry.getPortletApplications" ,this); 
...
{ 
  ...
  this.load = function(appName)
  {
     ...
     var requestCaller = new XMLHttpRequestCaller(applicationRoot+"/ajax?ajax_service=portletRegistry.getPortletApplication&ajax_param_0_str="+appName ,this); 
     requestCaller.serviceRequest();
  }
}
...
function PortletEntityLoader(elementId, blockId)
{
  ...
  {
      var requestCaller = new XMLHttpRequestCaller(applicationRoot+"/ajax?ajax_service=entityAccess.getPortletEntities&ajax_param_0_str="+portletName ,this); 
      requestCaller.serviceRequest();
  }
}
