...
<h:panelGroup>
    ...
    <h:form id="criterionForm" name="criterionForm">
        ...
        <h:message for="value" styleClass="error" showDetail="true" showSummary="false" />

        <h:outputLabel for="resolver" value="#{MESSAGE['criterion.resolver']}: "/>
        <h:selectOneMenu id="resolver" styleClass='portlet-form-label' value="#{criterion.resolver}">
        	<f:selectItems value="#{criterion.resolvers}"/>
        </h:selectOneMenu>        
        <h:message for="resolver" styleClass="error" showDetail="true" showSummary="false" />

        <h:outputLabel for="fallbackType" value="#{MESSAGE['criterion.fallback.type']}: "/>
        <h:selectOneMenu id="fallbackType" styleClass='portlet-form-label' value="#{criterion.fallbackType}">
        	<f:selectItems value="#{criterion.fallbackTypes}"/>
        </h:selectOneMenu>        
        <h:message for="fallbackType" styleClass="error" showDetail="true" showSummary="false" />
        ...
        <h:message for="fallbackOrder" styleClass="error" showDetail="true" showSummary="false" />
