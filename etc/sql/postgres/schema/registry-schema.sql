...
CREATE TABLE CUSTOM_PORTAL_MODE
(
    ID int4 NOT NULL,
    APPLICATION_ID int4 NOT NULL,
...
ALTER TABLE CUSTOM_PORTAL_MODE
    ADD CONSTRAINT CUSTOM_PORTAL_MODE_PK
PRIMARY KEY (ID);
...
ALTER TABLE CUSTOM_PORTAL_MODE
    ADD CONSTRAINT CUSTOM_PORTAL_MODE_FK_1 FOREIGN KEY (APPLICATION_ID)
    REFERENCES PORTLET_APPLICATION (APPLICATION_ID)
ON DELETE CASCADE
;
...
ALTER TABLE CUSTOM_WINDOW_STATE
    ADD CONSTRAINT CUSTOM_WINDOW_STATE_FK_1 FOREIGN KEY (APPLICATION_ID)
    REFERENCES PORTLET_APPLICATION (APPLICATION_ID)
ON DELETE CASCADE
;
