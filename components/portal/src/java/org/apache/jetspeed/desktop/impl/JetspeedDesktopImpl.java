...
public class JetspeedDesktopImpl implements JetspeedDesktop, ServletContextAware
{
    ...
    private final static String[] DESKTOP_ACTIONS = new String[] { "menu", "tile", "untile", "heightexpand", "heightnormal", "restore", "removeportlet", "loadportletrender", "loadportletaction", "loadportletupdate", "addportlet", "editpage", "loadpage" };
