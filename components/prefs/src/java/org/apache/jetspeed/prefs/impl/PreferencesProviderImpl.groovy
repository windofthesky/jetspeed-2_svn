...
return new PreferencesProviderImpl( picoContainer.getComponentInstance(PersistenceStoreContainer), "jetspeed", "org.apache.jetspeed.prefs.impl.PreferencesFactoryImpl" )	
