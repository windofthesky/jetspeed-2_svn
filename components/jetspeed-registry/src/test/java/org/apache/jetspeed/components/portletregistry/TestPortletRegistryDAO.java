...
public class TestPortletRegistryDAO extends DatasourceEnabledSpringTestCase
{
    ...
    throws RegistryException
    {
        ...
        fr1.setDescription("Le Vieux Ordinaire événement");        
        ...
        d6.setDescription("Écoutez moi une fois");
        ...
        dn6.setDisplayName("Écoutez moi deux fois");
        ...
        d8.setDescription("N'écoutez pas moi");
    ...
    {   
        ...
        assertEquals(fr.getDescription(), "Le Vieux Ordinaire événement");        
        ...
        assertEquals(d6.getDescription(), "Écoutez moi une fois");
        ...
        assertEquals(dn6.getDisplayName(), "Écoutez moi deux fois");
        ...
        d6 = descs.get(1);
        assertEquals(d6.getLang(), "fr");
        assertEquals(d6.getDescription(), "N'écoutez pas moi");
