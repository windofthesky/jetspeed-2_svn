...
public class TestPortletRegistryDAO extends DatasourceEnabledSpringTestCase
{
    ...
    throws RegistryException
    {
        ...
        d6.setDescription("ツoutez moi une fois");
        ...
        dn6.setDisplayName("ツoutez moi deux fois");
    ...
    {   
        ...
        assertEquals(d6.getDescription(), "ツoutez moi une fois");
        ...
        assertEquals(dn6.getDisplayName(), "ツoutez moi deux fois");
        ...
        d6 = descs.get(1);
        assertEquals(d6.getLang(), "fr");
        assertEquals(d6.getDescription(), "N'残outez pas moi");
        ...
        dn6 = dnames.get(1);
        assertEquals(dn6.getLang(), "fr");
        assertEquals(dn6.getDisplayName(), "ツoutez!");
    }
